...
ds_bp = Blueprint("ds", __name__, url_prefix = '/api/ds')
ds_api = Api(ds_bp)
...
class DSAPI(Resource):
    def post(self):
        ...
        ds = DS(args["socialclass"],args["age"],args["sex"],args["siblings"],args["family"], args["fare"], args["port"], args["alone"], alive_proba)
